              ...
              MySqlConnection con = new MySqlConnection(conString);
                {
                    ...
                    string query = "UPDATE tap.flowers SET Title=@Title , Description=@Description, " +
       ...
       public static bool Insert(Product product)
        {
            ...
            try
            {
                MySqlConnection con = new MySqlConnection(conString);
                {
                    if (con.State == ConnectionState.Closed)
                    con.Open();
                    string query = "INSERT INTO tap.flowers (Id,Title, Description, ImageUrl, UnitPrice, Quantity) " +
